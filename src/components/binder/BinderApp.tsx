      ...
      <div className="shrink-0 px-4 pt-4 md:px-10 md:pt-8.5">
        <div className="mb-3 flex flex-wrap items-end justify-between gap-5 md:mb-4">
          ...
          <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:items-center sm:gap-3">
            {/* View group: what you're looking at — search + scope */}
            <div className="flex w-full flex-col gap-2 sm:w-auto sm:flex-row sm:items-center sm:gap-2">
              <div className="relative w-full sm:w-[200px]">
                ...
                <input
                  ...
                  className="w-full min-h-[40px] rounded border border-line bg-card py-1.5 pr-3.5 pl-8 font-mono text-[13px] text-ink outline-none focus:border-ink sm:min-h-[44px] sm:py-2.5"
                />
              </div>
              <div className="flex gap-1">
                <button
                  ...
                  className={
                    "min-h-[28px] rounded px-2.5 py-1 font-mono text-[10.5px] tracking-[0.04em] uppercase transition-colors duration-150 sm:min-h-[32px] sm:px-3 sm:text-[11px] " +
                    (searchScope === "mine"
                      ? "bg-ink text-paper"
            ...
            {/* Structural separator between "what you're looking at" and
                "things you do" — desktop only, the groups already stack
                on their own lines on mobile. */}
            <div className="hidden h-7 w-px shrink-0 bg-line sm:block" />

            {/* Action group: Quiz and ⋮ are demoted to compact icon
                buttons so "+ New entry" — the one primary action — is the
                only thing that visually competes for attention. */}
            <div className="flex items-center gap-1.5 sm:gap-2">
              <button
                ...
                aria-label="Quiz"
                className="flex min-h-[40px] shrink-0 items-center gap-1.5 rounded border border-line px-3 text-[12px] font-semibold text-ink-soft transition-colors duration-150 hover:bg-paper-grid hover:text-ink active:scale-[0.97] sm:min-h-[44px] sm:text-[13.5px]"
              >
                <svg
                  width="14"
                  height="14"
              ...
              <button
                ...
                className="flex min-h-[40px] flex-1 items-center justify-center rounded bg-ink px-4 text-[13px] font-semibold text-paper transition-[background-color,opacity,transform] duration-150 hover:opacity-88 active:scale-[0.97] sm:min-h-[44px] sm:flex-none sm:text-[13.5px]"
              >
                + New entry
              </button>
              <div className="relative shrink-0" ref={moreMenuRef}>
                <button
                  ...
                  className={
                    "flex min-h-[40px] min-w-[40px] items-center justify-center rounded border border-line text-[15px] font-semibold text-ink transition-colors duration-150 hover:bg-paper-grid active:scale-[0.97] sm:min-h-[44px] sm:min-w-[44px] " +
                    (isMoreOpen ? "bg-ink text-paper hover:bg-ink" : "")
                  }
                >
                  &#8942;
                </button>
        ...
        {isSelectMode && selectedIds.size > 0 && (
          <div className="mb-3 flex w-full flex-wrap items-center gap-1.5 rounded border border-line bg-paper-grid px-2.5 py-1.5 sm:w-auto sm:gap-2 sm:px-3 sm:py-2 md:mb-4">
